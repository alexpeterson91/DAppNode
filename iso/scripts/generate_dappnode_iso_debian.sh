...
# Source = http://cdimage.debian.org/cdimage/unofficial/non-free/cd-including-firmware/current/amd64/iso-cd/
ISO_NAME=firmware-11.1.0-amd64-netinst.iso
ISO_PATH="/images/${ISO_NAME}"
ISO_URL=http://194.71.11.163/cdimage/unofficial/non-free/cd-including-firmware/archive/11.1.0+nonfree/amd64/iso-cd/
